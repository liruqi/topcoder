...
int m;			//m is the number of traveling days
int exp[maxn][maxn];	//exp[i][j]: expense from city i to j
int inc[maxn][maxn];	//inc[i][j]: income from city j in the i day 
int A[maxn][maxn];		//A[i][j]: total income in ith day in city j
